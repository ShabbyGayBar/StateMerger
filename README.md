...
Check out my [State Merging Mod](https://steamcommunity.com/sharedfiles/filedetails/?id=3371693463) generated by this script! Available on Steam Workshop!
...
The keys in the `merge_state.json` file strings representing a state id. The values are lists of strings representing state id.

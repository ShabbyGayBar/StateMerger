...
- **二选一：**
  ...
  - **或：**
  - 安装 [Python 3.14 或更高版本](https://www.python.org/downloads/)。
  - 在命令行中运行
    `pip install "https://github.com/ShabbyGayBar/StateMerger/releases/download/v2.1.2/vic3_state_merger-2.1.2-py3-none-any.whl"`
    以通过 pip 安装本包。
- **二选一：**
